...
// The canonical 16-color Nord palette (https://www.nordtheme.com/docs/colors-and-palettes).

// Polar Night — dark backgrounds/surfaces
val nord0 = Color(0xFF2E3440)
val nord1 = Color(0xFF3B4252)
val nord2 = Color(0xFF434C5E)
val nord3 = Color(0xFF4C566A)

// Snow Storm — light backgrounds/surfaces
...
val nord11 = Color(0xFFBF616A) // red / error
val nord12 = Color(0xFFD08770) // orange
val nord13 = Color(0xFFEBCB8B) // yellow / warning
val nord14 = Color(0xFFA3BE8C) // green / success
